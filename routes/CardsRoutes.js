 ...
 * @security JWT
 */
router.delete('/:id', CardAccess.updateRights(), function(req, res) {
    req.card.remove();
    req.card.save((err) => {
 ...
 * @security JWT
 */
router.post('/:id/idLabels', CardAccess.updateRights(), function(req, res) {
 ...
 * @security JWT
 */
router.delete('/:id/idLabels/:idLabel', CardAccess.updateRights(), function(req, res) {
